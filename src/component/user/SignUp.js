...
function SignUp() {
	...
	const [isNumberOk, setisNumberOk] = React.useState(true);
			...
			<Form inline>
				...
				<FormGroup>
					<Input
						...
						name="genre"
					>
						<option value={config.cherche.femme}>{config.cherche.femme}</option>
						<option value={config.cherche.homme}>{config.cherche.homme}</option>
					</Input>
				</FormGroup>
				<FormGroup>
					<fieldset
					...
					>
						...
						/>
						<p style={{ color: "red" }}>
							{isNumberOk ? "" : "Le numéro de téléphone est incorret"}
						</p>
					</fieldset>
				</FormGroup>{" "}
				<FormGroup>
				...
				<p style={{ color: "red" }}>
					{" "}
					{isPassEgal ? "" : "Les mots de passe ne corespondent pas"}
				</p>{" "}
